...
class MainController implements Controller
{
    ...
    {
        return (new ResponseBuilder())->initHtmlIncomplete("<p>Hello World!</p>")->build();
    }

    private function handleProjects(Request $oRequest)
    {
        $oTemplate = new PhpTemplate("../app/view/projects.tpl.php");
        // TODO
        return (new ResponseBuilder())->initHtmlIncomplete($oTemplate)->build();
    }

    private function handleTickets(Request $oRequest)
    {
        return (new ResponseBuilder())->initHtmlIncomplete("<p>Tickets&hellip;</p>")->build();
    }
